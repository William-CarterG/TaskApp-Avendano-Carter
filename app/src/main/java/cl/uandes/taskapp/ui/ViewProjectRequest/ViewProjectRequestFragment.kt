package cl.uandes.taskapp.ui.ViewProjectRequest
...
class ViewProjectRequestFragment : Fragment() {
    ...
    private fun returnToHomeProjects(){
        ...
        leaveAddMembersButton.setOnClickListener {
            val action =
                cl.uandes.taskapp.ui.ViewProjectRequest.ViewProjectRequestFragmentDirections.actionViewProjectRequestFragmentToHomeProjectsFragment()
